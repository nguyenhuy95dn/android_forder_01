...
import com.example.duong.android_forder_01.ui.yourorder.YourOrderActionHandler;
import com.example.duong.android_forder_01.ui.yourorder.YourOrderContract;
 ...
 */
public class YourOrderAdapter extends BaseExpandableListAdapter {
    private Context mContext;
    private List<Orders> mOrders = new ArrayList<>();
    private YourOrderContract.Presenter mListener;

    public YourOrderAdapter(Context context, List<Orders> orders,
                            YourOrderContract.Presenter presenter) {
        mContext = context;
        mOrders = orders;
        mListener = presenter;
    }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.item_parent_your_order, null);
        }
        ViewDataBinding mBinding = DataBindingUtil.bind(convertView);
        mBinding.setVariable(BR.order, getGroup(groupPosition));
        mBinding.setVariable(BR.actionHandler, new YourOrderActionHandler(mListener));
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) mContext
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.item_your_order, null);
        }
        ViewDataBinding mBinding = DataBindingUtil.bind(convertView);
