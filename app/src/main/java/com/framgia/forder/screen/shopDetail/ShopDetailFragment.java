...
public class ShopDetailFragment extends Fragment {
    private static String EXTRA_SHOP = "EXTRA_SHOP";
    private ShopDetailContract.ViewModel mViewModel;

    public static ShopDetailFragment newInstance(Object item) {
        ShopDetailFragment shopDetailFragment = new ShopDetailFragment();
        Bundle bundle = new Bundle();
        bundle.putParcelable(EXTRA_SHOP, (Parcelable) item);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        ShopDetailContract.Presenter presenter =
                new ShopDetailPresenter(mViewModel, userRepository, domainRepository,
                        shopRepository);
